...
function V(r,h)
    {
        ...
        document.getElementsByName('obj')[0].value=V_wynik.toFixed(2); /*  dokument */
        alert("V="+V_wynik.toFixed(2)+" cm^3"); /* Alert */
        pokaz1.innerHTML="V="+V_wynik.toFixed(2)+" cm^3"+"<br>";  /*  tabeli */
    }
function Pc(r,h)    
    {
        r_liczba=parseFloat(r)
